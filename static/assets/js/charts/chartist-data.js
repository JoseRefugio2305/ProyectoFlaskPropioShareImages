    ...
    if($("#costRevenue").length) {
        ...
        var data = {
          ...
          series: [
            ...
            [datadata.datagraf[0][0],datadata.datagraf[1][0],datadata.datagraf[2][0],datadata.datagraf[3][0],datadata.datagraf[4][0],
            datadata.datagraf[5][0],datadata.datagraf[6][0],datadata.datagraf[7][0],datadata.datagraf[8][0],datadata.datagraf[9][0],
            datadata.datagraf[10][0],datadata.datagraf[11][0]]
          ]
      };
